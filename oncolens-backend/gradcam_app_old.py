...
# Same-origin local page needs no CORS. Optional website origins are explicit.
origins = [x.strip() for x in os.getenv("ONCOLENS_ALLOWED_ORIGINS", "").split(",") if x.strip()]
if origins:
    app.add_middleware(
        CORSMiddleware,
